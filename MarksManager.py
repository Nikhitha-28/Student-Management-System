...
class Class_Marks:
    def __init__(self, root, ls, frame_old):
        ...
        lbl_sub4 = Label(Manage_Frame, text="IE: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub6 = Label(Manage_Frame, text="SDC: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
